...
<div class="main clearfix">
    ...
    <div class="main_info">
        <div class="tensense_position">
            <i class="iconfont icon-home">&nbsp;我的位置：工作管理&nbsp;>&nbsp;试验委托</i>
        </div>
        <!--委托台账-->
        <ul class="tensense_work_test tensense_global">
            <li class="title">
                <i class="iconfont icon-test">&nbsp;委托台账</i>
            </li>
            <li>
                ...
                <table class="overflowTable">
                    ...
                    <? } else {
                        ...
                        foreach ($testList as $test) { ?>
                            <tr>
                                <td><?= $i; ?></td>
                                <td><?=$test['entrust_agency'];?></td>
                                <td><?=$test['trustee_agency'];?></td>
                                <td><?=$test['project_name'];?></td>
                                <td><?=$test['category_name'];?></td>
                                <td><?=$test['test_engineer_info'];?></td>
                                <td><?=$test['test_detect_info'];?></td>
                                <td><?=date('Y-m-d H:i:s',$test['entrust_dateline']);?></td>
